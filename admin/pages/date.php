                                        ...
                                        <form method="POST">
                                            <div class="inner-form">
                                                <div class="main-form" id="main-form">
                                                    <div class="dte cale">
                                                        <div class="input-wrap">
                                                            ...
                                                            <div class="input-field">
                                                                ...
                                                                placeholder="dd/mm/yy"  value="<?php if(isset($_POST['save'])){ echo $_POST['date_start']; }?>" name="date_start">
                                                            </div>
                                                        </div>
                                                        <div class="input-wrap">
                                                            <div class="icon-wrap">
                                                            ...
                                                            <div class="input-field">
                                                                <label>TO</label>
                                                                <input class="datepicker flatpickr-input" type="date" 
                                                                placeholder="dd/mm/yy"  value="<?php if(isset($_POST['save'])){ echo $_POST['date_end']; }?>" name="date_end">
                                                            </div>
                                                        </div>                                                
                                                    </div>
                                                    <div class="dte cale">
                                                    ...
                                                    <!-- DROP DOWN LIST-->
                                                        <div class="django" style="padding-top:18px">
                                                            <ul class="menu">
                                                                <li><a href="#s1">Category</a>
                                                                    <ul class="submenu">
                                                                        <li><a href="#">ALL</a></li>
                                                    ...
                                                    <!--/ DROP DOWN LIST END -->
                                                        ...
                                                        <div class="django" style="padding-top:18px">
                                                           <select name="category" class="btn btn-prima" style="font-size:14px">
